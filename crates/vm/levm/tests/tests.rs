...
fn caller_op() {
    ...
    assert_eq!(
        vm.env.consumed_gas,
        U256::from(TX_BASE_COST) + gas_cost::CALLER
    );
}
...
fn origin_op() {
    ...
    assert_eq!(
        vm.env.consumed_gas,
        U256::from(TX_BASE_COST) + gas_cost::ORIGIN
    );
}
...
fn address_op() {
    ...
    assert_eq!(
        vm.env.consumed_gas,
        U256::from(TX_BASE_COST) + gas_cost::ADDRESS
    );
}
...
fn selfbalance_op() {
    ...
    assert_eq!(
        vm.env.consumed_gas,
        U256::from(TX_BASE_COST) + gas_cost::SELFBALANCE
    );
}
...
fn callvalue_op() {
    ...
    assert_eq!(
        vm.env.consumed_gas,
        U256::from(TX_BASE_COST) + gas_cost::CALLVALUE
    );
}
...
fn codesize_op() {
    ...
    assert_eq!(
        vm.env.consumed_gas,
        U256::from(TX_BASE_COST) + gas_cost::CODESIZE
    );
}
...
fn gasprice_op() {
    ...
    assert_eq!(
        vm.env.consumed_gas,
        U256::from(TX_BASE_COST) + gas_cost::GASPRICE
    );
}
