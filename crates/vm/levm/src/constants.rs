...
pub mod gas_cost {
    ...
    pub const SELFDESTRUCT_STATIC: U256 = U256([5000, 0, 0, 0]); // 5000
    pub const SELFDESTRUCT_DYNAMIC_BASE: U256 = U256([25000, 0, 0, 0]);
    pub const SELFDESTRUCT_DYNAMIC_COLD: U256 = U256([2600, 0, 0, 0]);
}
