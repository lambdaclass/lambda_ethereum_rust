...
impl RLPxClient {
    ...
    pub fn encode_auth_message(
        ...
        let msg = self.encrypt_message(remote_static_pubkey, encoded_auth_msg);
    ...
    pub fn decode_auth_message(
        ...
        let payload = self.decrypt_message(static_key, msg, auth_data);
        ...
        let auth_message = [&auth_data, msg].concat();
        ...
        let remote_ephemeral_key = self.retrieve_remote_ephemeral_key(
        ...
        self.remote_ephemeral_key = Some(remote_ephemeral_key);
        self.remote_init_message = Some(auth_message);
    ...
    pub fn encode_ack_message(
        ...
        let msg = self.encrypt_message(remote_static_pubkey, encoded_ack_msg);
