...
- [Roadmap](#roadmap)
  ...
  - [Milestone 1: MVP](#milestone-1-mvp)
    - [Status](#status-1)
  - [Milestone 2: State diffs + blobs + custom native token](#milestone-2-state-diffs--blobs--custom-native-token)
    - [Status](#status-2)
  - [Milestone 3: Validium + Account Abstraction](#milestone-3-validium--account-abstraction)
    - [Status](#status-3)
  - [Milestone 4: Security (TEEs and Multi Prover support)](#milestone-4-security-tees-and-multi-prover-support)
    - [Status](#status-4)
